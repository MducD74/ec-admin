...
`;function de(e,t){return t<=7?Array.from({length:t},(e,t)=>t+1):e<=4?[1,2,3,4,5,`ellipsis-right`,t]:e>=t-3?[1,`ellipsis-left`,t-4,t-3,t-2,t-1,t]:[1,`ellipsis-left`,e-1,e,e+1,`ellipsis-right`,t]}function fe({currentPage:e,totalPages:t,onPageChange:n}){if(t<=1)return null;let r=Math.min(Math.max(e,1),t),i=de(r,t);return(0,f.jsxs)(`nav`,{className:`admin-pagination`,"aria-label":`Pagination`,children:[(0,f.jsx)(`style`,{children:k}),(0,f.jsx)(`button`,{type:`button`,className:`admin-pagination-button admin-pagination-step`,disabled:r===1,onClick:()=>n(r-1),children:`Trước`}),(0,f.jsx)(`div`,{className:`admin-pagination-pages`,children:i.map(e=>{if(typeof e!=`number`)return(0,f.jsx)(`span`,{className:`admin-pagination-ellipsis`,"aria-hidden":`true`,children:`...`},e);let t=e===r;return(0,f.jsx)(`button`,{type:`button`,className:t?`admin-pagination-button active`:`admin-pagination-button`,"aria-current":t?`page`:void 0,onClick:()=>n(e),children:e},e)})}),(0,f.jsx)(`button`,{type:`button`,className:`admin-pagination-button admin-pagination-step`,disabled:r===t,onClick:()=>n(r+1),children:`Sau`})]})}var k=`
  .admin-pagination {
    display: flex;
    flex-wrap: wrap;
    align-items: center;
...
`,A=(0,l.memo)(fe),pe={name:``,description:``,sku:``,price:``,brandId:``,categoryId:``,quantity:``},me={name:``,description:``,logoUrl:``},he={name:``,parentId:``},ge=new Intl.NumberFormat(`vi-VN`,{style:`currency`,currency:`VND`,maximumFractionDigits:0});function _e(e){return ge.format(Number(e))}function ve(e){return e.data??e.products??[]}function ye(e){return e.data??e.brands??[]}function be(e){return e.flatMap(e=>[e,...be(e.children??[])])}function xe(e){return e.inventory?.filter(e=>e.status===`AVAILABLE`).length??0}function Se(){let[e,t]=(0,l.useState)([]),[n,r]=(0,l.useState)(1),[i,a]=(0,l.useState)(null),[o,s]=(0,l.useState)([]),[c,u]=(0,l.useState)([]),[d,p]=(0,l.useState)(pe),[m,h]=(0,l.useState)(!0),[g,_]=(0,l.useState)(!1),[v,y]=(0,l.useState)(null),[b,x]=(0,l.useState)(!1),[S,C]=(0,l.useState)(me),[w,ee]=(0,l.useState)(!1),[te,ne]=(0,l.useState)(!1),[re,ie]=(0,l.useState)(he),[ae,oe]=(0,l.useState)(!1),se=(0,l.useMemo)(()=>be(o),[o]),E=(0,l.useCallback)((e,t)=>{y({type:e,message:t}),window.setTimeout(()=>y(null),3e3)},[]),ce=(0,l.useCallback)(async()=>{h(!0);try{let e=await T.get(`/products?page=${n}&limit=10`);t(ve(e)),a(e.meta??(e.pagination?{totalItems:e.pagination.total??0,totalPages:e.pagination.totalPages??1,currentPage:e.pagination.page??n,limit:e.pagination.limit??10}:null))}catch{E(`error`,`Không thể tải danh sách sản phẩm.`)}finally{h(!1)}},[n,E]),D=(0,l.useCallback)(async()=>{try{let e=await T.get(`/admin/categories`);s(e.data??e.categories??[])}catch{E(`error`,`Không thể tải danh mục sản phẩm.`)}},[E]),O=(0,l.useCallback)(async()=>{try{u(ye(await T.get(`/admin/brands`)))}catch{E(`error`,`Không thể tải danh sách thương hiệu.`)}},[E]);(0,l.useEffect)(()=>{ce(),D(),O()},[ce,D,O]);let le=(e,t)=>{p(n=>({...n,[e]:t}))},ue=async e=>{e.preventDefault(),_(!0);try{await T.post(`/admin/products`,{name:d.name.trim(),description:d.description.trim(),sku:d.sku.trim(),price:Number(d.price),brandId:d.brandId?Number(d.brandId):null,categoryId:d.categoryId?Number(d.categoryId):null,quantity:Number(d.quantity||0)}),p(pe),E(`success`,`Đã thêm sản phẩm mới.`),await ce()}catch{E(`error`,`Không thể thêm sản phẩm mới.`)}finally{_(!1)}},de=(e,t)=>{C(n=>({...n,[e]:t}))},fe=async()=>{if(!S.name.trim()){E(`error`,`Vui lòng nhập tên thương hiệu.`);return}ee(!0);try{await T.post(`/admin/brands`,{name:S.name.trim(),description:S.description.trim(),logoUrl:S.logoUrl.trim()||null}),C(me),x(!1),E(`success`,`Đã thêm thương hiệu mới.`),await O()}catch{E(`error`,`Không thể thêm thương hiệu mới.`)}finally{ee(!1)}},k=(e,t)=>{ie(n=>({...n,[e]:t}))},ge=async()=>{if(!re.name.trim()){E(`error`,`Vui lòng nhập tên danh mục.`);return}oe(!0);try{await T.post(`/admin/categories`,{name:re.name.trim(),parentId:re.parentId?Number(re.parentId):null}),ie(he),ne(!1),E(`success`,`Đã thêm danh mục mới.`),await D()}catch{E(`error`,`Không thể thêm danh mục mới.`)}finally{oe(!1)}};return(0,f.jsxs)(`section`,{className:`catalog-management`,children:[(0,f.jsx)(`style`,{children:Ce}),v&&(0,f.jsx)(`div`,{className:`catalog-management-toast catalog-management-toast-${v.type}`,role:`status`,children:v.message}),(0,f.jsxs)(`div`,{className:`catalog-management-header`,children:[(0,f.jsx)(`div`,{}),(0,f.jsx)(`button`,{type:`button`,className:`catalog-management-refresh`,onClick:()=>void ce(),children:`Tải lại`})]}),(0,f.jsxs)(`form`,{className:`catalog-management-form`,onSubmit:e=>void ue(e),children:[(0,f.jsxs)(`div`,{className:`catalog-management-form-title`,children:[(0,f.jsx)(`h3`,{children:`Thêm sản phẩm mới`}),(0,f.jsx)(`p`,{children:`Nhập thông tin cơ bản và số lượng kho ban đầu cho sản phẩm.`})]}),(0,f.jsxs)(`div`,{className:`catalog-management-form-grid`,children:[(0,f.jsxs)(`label`,{children:[`Tên sản phẩm`,(0,f.jsx)(`input`,{required:!0,value:d.name,onChange:e=>le(`name`,e.target.value),placeholder:`Ví dụ: iPhone 15 Pro Max`})]}),(0,f.jsxs)(`label`,{children:[`Mô tả`,(0,f.jsx)(`input`,{value:d.description,onChange:e=>le(`description`,e.target.value),placeholder:`Mô tả ngắn về sản phẩm`})]}),(0,f.jsxs)(`label`,{children:[`Mã SKU`,(0,f.jsx)(`input`,{required:!0,value:d.sku,onChange:e=>le(`sku`,e.target.value),placeholder:`Ví dụ: IP16P-256-BLK`})]}),(0,f.jsxs)(`label`,{children:[`Giá bán`,(0,f.jsx)(`input`,{required:!0,min:`0`,type:`number`,value:d.price,onChange:e=>le(`price`,e.target.value),placeholder:`Ví dụ: 29990000`})]}),(0,f.jsxs)(`label`,{children:[(0,f.jsxs)(`span`,{className:`catalog-management-label-row`,children:[`Thương hiệu`,(0,f.jsx)(`button`,{type:`button`,className:`catalog-management-inline-toggle`,onClick:()=>x(e=>!e),children:b?`Đóng`:`+ Thêm thương hiệu`})]}),(0,f.jsxs)(`select`,{value:d.brandId,onChange:e=>le(`brandId`,e.target.value),children:[(0,f.jsx)(`option`,{value:``,children:`Chưa chọn thương hiệu`}),c.map(e=>(0,f.jsx)(`option`,{value:e.id,children:e.name},e.id))]})]}),b&&(0,f.jsx)(`div`,{className:`catalog-management-inline-form`,children:(0,f.jsxs)(`div`,{children:[(0,f.jsxs)(`div`,{className:`catalog-management-inline-form-grid`,children:[(0,f.jsxs)(`label`,{children:[`Tên thương hiệu`,(0,f.jsx)(`input`,{required:!0,value:S.name,onChange:e=>de(`name`,e.target.value),placeholder:`Ví dụ: Apple`})]}),(0,f.jsxs)(`label`,{children:[`Mô tả`,(0,f.jsx)(`input`,{value:S.description,onChange:e=>de(`description`,e.target.value),placeholder:`Mô tả ngắn`})]}),(0,f.jsxs)(`label`,{children:[`Logo URL`,(0,f.jsx)(`input`,{value:S.logoUrl,onChange:e=>de(`logoUrl`,e.target.value),placeholder:`https://...`})]})]}),(0,f.jsx)(`div`,{className:`catalog-management-form-actions`,children:(0,f.jsxs)(`button`,{type:`button`,disabled:w,onClick:()=>void fe(),children:[w&&(0,f.jsx)(`span`,{className:`catalog-management-spinner small`}),`Lưu thương hiệu`]})})]})}),(0,f.jsxs)(`label`,{children:[(0,f.jsxs)(`span`,{className:`catalog-management-label-row`,children:[`Danh mục`,(0,f.jsx)(`button`,{type:`button`,className:`catalog-management-inline-toggle`,onClick:()=>ne(e=>!e),children:te?`Đóng`:`+ Thêm danh mục`})]}),(0,f.jsxs)(`select`,{value:d.categoryId,onChange:e=>le(`categoryId`,e.target.value),children:[(0,f.jsx)(`option`,{value:``,children:`Chưa chọn danh mục`}),se.map(e=>(0,f.jsx)(`option`,{value:e.id,children:e.name},e.id))]})]}),te&&(0,f.jsx)(`div`,{className:`catalog-management-inline-form`,children:(0,f.jsxs)(`div`,{children:[(0,f.jsxs)(`div`,{className:`catalog-management-inline-form-grid`,children:[(0,f.jsxs)(`label`,{children:[`Tên danh mục`,(0,f.jsx)(`input`,{required:!0,value:re.name,onChange:e=>k(`name`,e.target.value),placeholder:`Ví dụ: Điện thoại`})]}),(0,f.jsxs)(`label`,{children:[`Danh mục cha`,(0,f.jsxs)(`select`,{value:re.parentId,onChange:e=>k(`parentId`,e.target.value),children:[(0,f.jsx)(`option`,{value:``,children:`Không có danh mục cha`}),se.map(e=>(0,f.jsx)(`option`,{value:e.id,children:e.name},e.id))]})]})]}),(0,f.jsx)(`div`,{className:`catalog-management-form-actions`,children:(0,f.jsxs)(`button`,{type:`button`,disabled:ae,onClick:()=>void ge(),children:[ae&&(0,f.jsx)(`span`,{className:`catalog-management-spinner small`}),`Lưu danh mục`]})})]})}),(0,f.jsxs)(`label`,{children:[`Số lượng kho ban đầu`,(0,f.jsx)(`input`,{required:!0,min:`0`,type:`number`,value:d.quantity,onChange:e=>le(`quantity`,e.target.value),placeholder:`Ví dụ: 20`})]})]}),(0,f.jsx)(`div`,{className:`catalog-management-form-actions`,children:(0,f.jsxs)(`button`,{type:`submit`,disabled:g,children:[g&&(0,f.jsx)(`span`,{className:`catalog-management-spinner small`}),`Thêm sản phẩm mới`]})})]}),(0,f.jsxs)(`section`,{className:`catalog-management-panel`,children:[m?(0,f.jsxs)(`div`,{className:`catalog-management-loading`,children:[(0,f.jsx)(`span`,{className:`catalog-management-spinner`}),`Đang tải danh sách sản phẩm...`]}):(0,f.jsxs)(`div`,{className:`catalog-management-table-wrap`,children:[(0,f.jsxs)(`table`,{className:`catalog-management-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Ảnh`}),(0,f.jsx)(`th`,{children:`Tên sản phẩm`}),(0,f.jsx)(`th`,{children:`Danh mục`}),(0,f.jsx)(`th`,{children:`Thương hiệu`}),(0,f.jsx)(`th`,{children:`Giá bán`}),(0,f.jsx)(`th`,{children:`Tồn kho`})]})}),(0,f.jsx)(`tbody`,{children:e.map(e=>(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:e.imageUrl?(0,f.jsx)(`img`,{className:`catalog-management-image`,src:e.imageUrl,alt:e.name}):(0,f.jsx)(`span`,{className:`catalog-management-image-placeholder`,children:`SP`})}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`strong`,{children:e.name})}),(0,f.jsx)(`td`,{children:e.category?.name??`Chưa phân loại`}),(0,f.jsx)(`td`,{children:e.brand?.name??`Chưa có`}),(0,f.jsx)(`td`,{className:`catalog-management-money`,children:_e(e.price)}),(0,f.jsx)(`td`,{children:xe(e)})]},e.id))})]}),e.length===0&&(0,f.jsx)(`p`,{className:`catalog-management-empty`,children:`Chưa có sản phẩm nào.`})]}),!m&&(0,f.jsx)(A,{currentPage:n,totalPages:i?.totalPages||1,onPageChange:e=>r(e)})]})]})}var Ce=`
  .catalog-management {
    display: grid;
    gap: 18px;
    color: #0f172a;
...
`,we={sku:``,attributeName:``,attributeValue:``,price:``,stock:``},Te=new Intl.NumberFormat(`vi-VN`,{style:`currency`,currency:`VND`,maximumFractionDigits:0});async function Ee(e,t){return T.request(e,t)}function De(e){return Te.format(Number(e))}function Oe(e){return e.data??e.products??[]}function ke(e){return e.data??e.variants??[]}function Ae(e){return`${e.attributeName} - ${e.attributeValue}`}function je(){let[e,t]=(0,l.useState)([]),[n,r]=(0,l.useState)(null),[i,a]=(0,l.useState)([]),[o,s]=(0,l.useState)({}),[c,u]=(0,l.useState)(we),[d,p]=(0,l.useState)(!0),[m,h]=(0,l.useState)(!1),[g,_]=(0,l.useState)(null),[v,y]=(0,l.useState)(!1),[b,x]=(0,l.useState)(null),S=(0,l.useMemo)(()=>n!==null,[n]),C=(0,l.useCallback)((e,t)=>{x({type:e,message:t}),window.setTimeout(()=>x(null),3e3)},[]),w=(0,l.useCallback)(async()=>{p(!0);try{t(Oe(await Ee(`/admin/products?limit=50`)))}catch{C(`error`,`Không thể tải danh sách sản phẩm.`)}finally{p(!1)}},[C]),ee=(0,l.useCallback)(async e=>{h(!0);try{let t=ke(await Ee(`/admin/products/${e}/variants`));a(t),s(Object.fromEntries(t.map(e=>[e.id,String(e.stock)])))}catch{a([]),s({}),C(`error`,`Không thể tải danh sách biến thể của sản phẩm.`)}finally{h(!1)}},[C]);(0,l.useEffect)(()=>{w()},[w]);let te=e=>{r(e),u(we),ee(e.id)},ne=(e,t)=>{s(n=>({...n,[e]:t}))},T=async e=>{let t=Number(o[e]);if(!Number.isInteger(t)||t<0){C(`error`,`Số lượng tồn kho phải là số nguyên không âm.`);return}_(e);try{await Ee(`/admin/product-variants/${e}`,{method:`PUT`,body:JSON.stringify({stock:t})}),C(`success`,`Đã cập nhật kho hàng.`),n&&await ee(n.id)}catch{C(`error`,`Không thể cập nhật kho hàng.`)}finally{_(null)}},re=(e,t)=>{u(n=>({...n,[e]:t}))},ie=async e=>{if(e.preventDefault(),!n){C(`error`,`Vui lòng chọn sản phẩm trước khi thêm biến thể.`);return}y(!0);try{await Ee(`/admin/products/${n.id}/variants`,{method:`POST`,body:JSON.stringify({sku:c.sku.trim(),attributeName:c.attributeName.trim(),attributeValue:c.attributeValue.trim(),price:Number(c.price),stock:Number(c.stock||0)})}),u(we),C(`success`,`Đã thêm biến thể mới.`),await ee(n.id)}catch{C(`error`,`Không thể thêm biến thể mới.`)}finally{y(!1)}};return(0,f.jsxs)(`section`,{className:`product-inventory`,children:[(0,f.jsx)(`style`,{children:Me}),b&&(0,f.jsx)(`div`,{className:`product-inventory-toast product-inventory-toast-${b.type}`,role:`status`,children:b.message}),(0,f.jsxs)(`div`,{className:`product-inventory-header`,children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`p`,{children:`Quản trị kho hàng`}),(0,f.jsx)(`h2`,{children:`Sản phẩm và biến thể`})]}),(0,f.jsx)(`button`,{type:`button`,className:`product-inventory-refresh`,onClick:()=>void w(),children:`Tải lại sản phẩm`})]}),(0,f.jsxs)(`div`,{className:`product-inventory-layout`,children:[(0,f.jsxs)(`section`,{className:`product-inventory-products`,children:[(0,f.jsxs)(`div`,{className:`product-inventory-panel-title`,children:[(0,f.jsx)(`h3`,{children:`Danh sách sản phẩm`}),(0,f.jsx)(`p`,{children:`Chọn một sản phẩm để quản lý biến thể và tồn kho.`})]}),d?(0,f.jsxs)(`div`,{className:`product-inventory-loading`,children:[(0,f.jsx)(`span`,{className:`product-inventory-spinner`}),`Đang tải danh sách sản phẩm...`]}):(0,f.jsxs)(`div`,{className:`product-inventory-product-list`,children:[e.map(e=>(0,f.jsxs)(`button`,{type:`button`,className:n?.id===e.id?`product-inventory-product active`:`product-inventory-product`,onClick:()=>te(e),children:[e.imageUrl?(0,f.jsx)(`img`,{src:e.imageUrl,alt:e.name}):(0,f.jsx)(`span`,{className:`product-inventory-image-placeholder`,children:`SP`}),(0,f.jsxs)(`span`,{children:[(0,f.jsx)(`strong`,{children:e.name}),(0,f.jsxs)(`small`,{children:[`SKU: `,e.sku,` · `,De(e.price)]})]})]},e.id)),e.length===0&&(0,f.jsx)(`p`,{className:`product-inventory-empty`,children:`Chưa có sản phẩm nào.`})]})]}),(0,f.jsxs)(`section`,{className:`product-inventory-detail`,children:[!S&&(0,f.jsxs)(`div`,{className:`product-inventory-placeholder`,children:[(0,f.jsx)(`h3`,{children:`Chưa chọn sản phẩm`}),(0,f.jsx)(`p`,{children:`Vui lòng chọn một sản phẩm ở danh sách bên trái để xem và chỉnh sửa biến thể.`})]}),n&&(0,f.jsxs)(f.Fragment,{children:[(0,f.jsxs)(`div`,{className:`product-inventory-detail-header`,children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`p`,{children:`Đang quản lý`}),(0,f.jsx)(`h3`,{children:n.name}),(0,f.jsxs)(`span`,{children:[`SKU gốc: `,n.sku]})]}),(0,f.jsx)(`button`,{type:`button`,onClick:()=>r(null),children:`Đóng chi tiết`})]}),m?(0,f.jsxs)(`div`,{className:`product-inventory-loading`,children:[(0,f.jsx)(`span`,{className:`product-inventory-spinner`}),`Đang tải biến thể sản phẩm...`]}):(0,f.jsxs)(`div`,{className:`product-inventory-table-wrap`,children:[(0,f.jsxs)(`table`,{className:`product-inventory-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Tên biến thể`}),(0,f.jsx)(`th`,{children:`SKU`}),(0,f.jsx)(`th`,{children:`Giá bán`}),(0,f.jsx)(`th`,{children:`Số lượng tồn kho`}),(0,f.jsx)(`th`,{children:`Cập nhật`})]})}),(0,f.jsx)(`tbody`,{children:i.map(e=>{let t=g===e.id;return(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:(0,f.jsx)(`strong`,{children:Ae(e)})}),(0,f.jsx)(`td`,{children:e.sku}),(0,f.jsx)(`td`,{className:`product-inventory-money`,children:De(e.price)}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`input`,{min:`0`,type:`number`,value:o[e.id]??String(e.stock),onChange:t=>ne(e.id,t.target.value)})}),(0,f.jsx)(`td`,{children:(0,f.jsxs)(`button`,{type:`button`,className:`product-inventory-update-stock`,disabled:t,onClick:()=>void T(e.id),children:[t&&(0,f.jsx)(`span`,{className:`product-inventory-spinner small`}),`Cập nhật kho hàng`]})})]},e.id)})})]}),i.length===0&&(0,f.jsx)(`p`,{className:`product-inventory-empty`,children:`Sản phẩm này chưa có biến thể nào.`})]}),(0,f.jsxs)(`form`,{className:`product-inventory-variant-form`,onSubmit:e=>void ie(e),children:[(0,f.jsxs)(`div`,{className:`product-inventory-panel-title`,children:[(0,f.jsx)(`h3`,{children:`Thêm biến thể mới`}),(0,f.jsx)(`p`,{children:`Nhập thông tin biến thể cho sản phẩm đang chọn.`})]}),(0,f.jsxs)(`div`,{className:`product-inventory-form-grid`,children:[(0,f.jsxs)(`label`,{children:[`SKU biến thể`,(0,f.jsx)(`input`,{required:!0,value:c.sku,onChange:e=>re(`sku`,e.target.value),placeholder:`Ví dụ: IP15-TTN-256`})]}),(0,f.jsxs)(`label`,{children:[`Tên thuộc tính`,(0,f.jsx)(`input`,{required:!0,value:c.attributeName,onChange:e=>re(`attributeName`,e.target.value),placeholder:`Ví dụ: Màu sắc`})]}),(0,f.jsxs)(`label`,{children:[`Giá trị thuộc tính`,(0,f.jsx)(`input`,{required:!0,value:c.attributeValue,onChange:e=>re(`attributeValue`,e.target.value),placeholder:`Ví dụ: Titan Tự Nhiên`})]}),(0,f.jsxs)(`label`,{children:[`Giá bán`,(0,f.jsx)(`input`,{required:!0,min:`0`,type:`number`,value:c.price,onChange:e=>re(`price`,e.target.value),placeholder:`Ví dụ: 29990000`})]}),(0,f.jsxs)(`label`,{children:[`Tồn kho`,(0,f.jsx)(`input`,{required:!0,min:`0`,type:`number`,value:c.stock,onChange:e=>re(`stock`,e.target.value),placeholder:`Ví dụ: 15`})]})]}),(0,f.jsxs)(`button`,{type:`submit`,disabled:v,children:[v&&(0,f.jsx)(`span`,{className:`product-inventory-spinner small`}),`Thêm biến thể mới`]})]})]})]})]})]})}var Me=`
  .product-inventory {
    display: grid;
    gap: 18px;
    color: #0f172a;
...
`,Ne=new Intl.DateTimeFormat(`vi-VN`,{day:`2-digit`,month:`2-digit`,year:`numeric`});async function Pe(e){return T.request(e)}function Fe(e){return e.data??e.users??[]}function Ie(e){return Ne.format(new Date(e))}function Le(e){if(!e)return;if(typeof e==`string`)return e.trim()||void 0;if(Array.isArray(e))return[...e].sort((e,t)=>(t.score??t.count??0)-(e.score??e.count??0))[0]?.brand;let[t]=Object.entries(e).sort(([,e],[,t])=>t-e)[0]??[];return t}function Re(e){let t=Le(e);return t?`Tín đồ ${t}`:`Chưa đủ dữ liệu`}function ze(){let[e,t]=(0,l.useState)([]),[n,r]=(0,l.useState)(!0),[i,a]=(0,l.useState)(null),o=(0,l.useMemo)(()=>e.length,[e]),s=(0,l.useCallback)(async()=>{r(!0),a(null);try{t(Fe(await Pe(`/admin/users`)))}catch{a(`Không thể tải danh sách người dùng.`)}finally{r(!1)}},[]);return(0,l.useEffect)(()=>{s()},[s]),(0,f.jsxs)(`section`,{className:`user-management`,children:[(0,f.jsx)(`style`,{children:Be}),(0,f.jsxs)(`div`,{className:`user-management-header`,children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`p`,{children:`Quản trị khách hàng`}),(0,f.jsx)(`h2`,{children:`Danh sách người dùng`})]}),(0,f.jsxs)(`div`,{className:`user-management-actions`,children:[(0,f.jsxs)(`span`,{children:[o,` người dùng`]}),(0,f.jsx)(`button`,{type:`button`,onClick:()=>void s(),children:`Tải lại`})]})]}),i&&(0,f.jsx)(`p`,{className:`user-management-error`,children:i}),(0,f.jsx)(`section`,{className:`user-management-panel`,children:n?(0,f.jsxs)(`div`,{className:`user-management-loading`,children:[(0,f.jsx)(`span`,{className:`user-management-spinner`}),`Đang tải danh sách người dùng...`]}):(0,f.jsxs)(`div`,{className:`user-management-table-wrap`,children:[(0,f.jsxs)(`table`,{className:`user-management-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Email`}),(0,f.jsx)(`th`,{children:`Tên hiển thị`}),(0,f.jsx)(`th`,{children:`Vai trò`}),(0,f.jsx)(`th`,{children:`Ngày tham gia`}),(0,f.jsx)(`th`,{children:`Hồ sơ Gu Thương hiệu (AI Profile)`})]})}),(0,f.jsx)(`tbody`,{children:e.map(e=>(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`td`,{children:(0,f.jsx)(`strong`,{children:e.email})}),(0,f.jsx)(`td`,{children:e.name??`Chưa cập nhật`}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`span`,{className:e.role===`ADMIN`?`user-role admin`:`user-role user`,children:e.role})}),(0,f.jsx)(`td`,{children:Ie(e.createdAt)}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`span`,{className:`brand-profile`,children:Re(e.brandAffinity??null)})})]},e.id))})]}),e.length===0&&(0,f.jsx)(`p`,{className:`user-management-empty`,children:`Chưa có người dùng nào.`})]})})]})}var Be=`
  .user-management {
    display: grid;
    gap: 18px;
    color: #0f172a;
...
`,Ve={code:``,discountType:`PERCENTAGE`,discountValue:``,minOrderValue:``,maxDiscountValue:``,usageLimit:``,description:``},He=new Intl.NumberFormat(`vi-VN`,{style:`currency`,currency:`VND`,maximumFractionDigits:0});async function Ue(e,t){return T.request(e,t)}function We(e){return He.format(Number(e))}function Ge(e){return e===`PERCENTAGE`?`Phần trăm`:`Số tiền cố định`}function Ke(e){return e.discountType===`PERCENTAGE`?`${e.discountValue}%`:We(e.discountValue)}function qe(e){return e.data??e.vouchers??[]}function Je(){let[e,t]=(0,l.useState)([]),[n,r]=(0,l.useState)(1),[i,a]=(0,l.useState)(null),[o,s]=(0,l.useState)(Ve),[c,u]=(0,l.useState)(!0),[d,p]=(0,l.useState)(!1),[m,h]=(0,l.useState)(null),[g,_]=(0,l.useState)(null),v=(0,l.useMemo)(()=>e,[e]),y=(0,l.useCallback)((e,t)=>{_({type:e,message:t}),window.setTimeout(()=>_(null),3e3)},[]),b=(0,l.useCallback)(async()=>{u(!0);try{let e=await Ue(`/admin/vouchers?page=${n}&limit=10`);t(qe(e)),a(e.meta??(e.pagination?{totalItems:e.pagination.total??0,totalPages:e.pagination.totalPages??1,currentPage:e.pagination.page??n,limit:e.pagination.limit??10}:null))}catch{y(`error`,`Không thể tải danh sách voucher.`)}finally{u(!1)}},[n,y]);(0,l.useEffect)(()=>{b()},[b]);let x=(e,t)=>{s(n=>({...n,[e]:t}))},S=async e=>{h(e.id);try{await Ue(`/admin/vouchers/${e.id}/toggle`,{method:`PUT`}),y(`success`,e.isActive?`Đã tắt mã voucher.`:`Đã bật mã voucher.`),await b()}catch{y(`error`,`Không thể cập nhật trạng thái voucher.`)}finally{h(null)}},C=async e=>{e.preventDefault(),p(!0);try{await Ue(`/admin/vouchers`,{method:`POST`,body:JSON.stringify({code:o.code.trim(),discountType:o.discountType,discountValue:Number(o.discountValue),minOrderValue:Number(o.minOrderValue||0),maxDiscountValue:o.maxDiscountValue?Number(o.maxDiscountValue):null,usageLimit:Number(o.usageLimit),description:o.description.trim()})}),s(Ve),y(`success`,`Đã thêm mã voucher mới.`),await b()}catch{y(`error`,`Không thể thêm mã voucher mới.`)}finally{p(!1)}};return(0,f.jsxs)(`section`,{className:`voucher-management`,children:[(0,f.jsx)(`style`,{children:Ye}),g&&(0,f.jsx)(`div`,{className:`voucher-management-toast voucher-management-toast-${g.type}`,role:`status`,children:g.message}),(0,f.jsxs)(`div`,{className:`voucher-management-header`,children:[(0,f.jsx)(`div`,{}),(0,f.jsx)(`button`,{type:`button`,className:`voucher-management-refresh`,onClick:()=>void b(),children:`Tải lại`})]}),(0,f.jsxs)(`form`,{className:`voucher-management-form`,onSubmit:e=>void C(e),children:[(0,f.jsxs)(`div`,{className:`voucher-management-form-title`,children:[(0,f.jsx)(`h3`,{children:`Thêm mã Voucher mới`}),(0,f.jsx)(`p`,{children:`Nhập thông tin mã giảm giá để tạo chương trình khuyến mãi mới.`})]}),(0,f.jsxs)(`div`,{className:`voucher-management-form-grid`,children:[(0,f.jsxs)(`label`,{children:[`Mã voucher`,(0,f.jsx)(`input`,{required:!0,value:o.code,onChange:e=>x(`code`,e.target.value),placeholder:`Ví dụ: SUMMER50`})]}),(0,f.jsxs)(`label`,{children:[`Loại giảm`,(0,f.jsxs)(`select`,{value:o.discountType,onChange:e=>x(`discountType`,e.target.value),children:[(0,f.jsx)(`option`,{value:`PERCENTAGE`,children:`Phần trăm`}),(0,f.jsx)(`option`,{value:`FIXED_AMOUNT`,children:`Số tiền cố định`})]})]}),(0,f.jsxs)(`label`,{children:[`Giá trị giảm`,(0,f.jsx)(`input`,{required:!0,min:`0`,type:`number`,value:o.discountValue,onChange:e=>x(`discountValue`,e.target.value),placeholder:`Ví dụ: 10`})]}),(0,f.jsxs)(`label`,{children:[`Đơn tối thiểu`,(0,f.jsx)(`input`,{min:`0`,type:`number`,value:o.minOrderValue,onChange:e=>x(`minOrderValue`,e.target.value),placeholder:`Ví dụ: 500000`})]}),(0,f.jsxs)(`label`,{children:[`Giảm tối đa`,(0,f.jsx)(`input`,{min:`0`,type:`number`,value:o.maxDiscountValue,onChange:e=>x(`maxDiscountValue`,e.target.value),placeholder:`Ví dụ: 200000`})]}),(0,f.jsxs)(`label`,{children:[`Giới hạn lượt dùng`,(0,f.jsx)(`input`,{required:!0,min:`1`,type:`number`,value:o.usageLimit,onChange:e=>x(`usageLimit`,e.target.value),placeholder:`Ví dụ: 100`})]})]}),(0,f.jsxs)(`label`,{className:`voucher-management-description`,children:[`Mô tả tiếng Việt`,(0,f.jsx)(`textarea`,{value:o.description,onChange:e=>x(`description`,e.target.value),placeholder:`Ví dụ: Giảm giá dành cho khách hàng mua laptop trong tháng này.`})]}),(0,f.jsx)(`div`,{className:`voucher-management-form-actions`,children:(0,f.jsxs)(`button`,{type:`submit`,disabled:d,children:[d&&(0,f.jsx)(`span`,{className:`voucher-management-spinner small`}),`Thêm mã Voucher mới`]})})]}),(0,f.jsxs)(`div`,{className:`voucher-management-panel`,children:[c?(0,f.jsxs)(`div`,{className:`voucher-management-loading`,children:[(0,f.jsx)(`span`,{className:`voucher-management-spinner`}),`Đang tải danh sách voucher...`]}):(0,f.jsxs)(`div`,{className:`voucher-management-table-wrap`,children:[(0,f.jsxs)(`table`,{className:`voucher-management-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Mã`}),(0,f.jsx)(`th`,{children:`Loại giảm`}),(0,f.jsx)(`th`,{children:`Giá trị`}),(0,f.jsx)(`th`,{children:`Đơn tối thiểu`}),(0,f.jsx)(`th`,{children:`Đã dùng / Giới hạn`}),(0,f.jsx)(`th`,{children:`Trạng thái`}),(0,f.jsx)(`th`,{children:`Bật/Tắt`})]})}),(0,f.jsx)(`tbody`,{children:v.map(e=>{let t=m===e.id;return(0,f.jsxs)(`tr`,{children:[(0,f.jsxs)(`td`,{children:[(0,f.jsx)(`strong`,{children:e.code}),e.description&&(0,f.jsx)(`span`,{children:e.description})]}),(0,f.jsx)(`td`,{children:Ge(e.discountType)}),(0,f.jsx)(`td`,{className:`voucher-management-money`,children:Ke(e)}),(0,f.jsx)(`td`,{children:We(e.minOrderValue)}),(0,f.jsxs)(`td`,{children:[e.usedCount,` / `,e.usageLimit]}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`span`,{className:e.isActive?`voucher-management-status active`:`voucher-management-status inactive`,children:e.isActive?`Đang hoạt động`:`Đã tạm dừng`})}),(0,f.jsx)(`td`,{children:(0,f.jsxs)(`button`,{type:`button`,className:e.isActive?`voucher-toggle on`:`voucher-toggle off`,disabled:t,onClick:()=>void S(e),"aria-pressed":e.isActive,children:[t?(0,f.jsx)(`span`,{className:`voucher-management-spinner small dark`}):null,e.isActive?`Tắt`:`Bật`]})})]},e.id)})})]}),v.length===0&&(0,f.jsx)(`p`,{className:`voucher-management-empty`,children:`Chưa có mã voucher nào.`})]}),!c&&(0,f.jsx)(A,{currentPage:n,totalPages:i?.totalPages||1,onPageChange:e=>r(e)})]})]})}var Ye=`
  .voucher-management {
    display: grid;
    gap: 18px;
    color: #0f172a;
...
`,Xe=[{value:`ALL`,label:`Tất cả`},{value:`PENDING`,label:`Chờ xử lý`},{value:`PROCESSING`,label:`Đang xử lý`},{value:`SHIPPED`,label:`Đang giao`},{value:`DELIVERED`,label:`Thành công`},{value:`CANCELLED`,label:`Đã hủy`}],Ze={PENDING:`Chờ xử lý`,PROCESSING:`Đang xử lý`,PAID:`Đã thanh toán`,SHIPPED:`Đang giao`,COMPLETED:`Thành công`,DELIVERED:`Thành công`,CANCELLED:`Đã hủy`,FAILED:`Thất bại`,REFUNDED:`Đã hoàn tiền`},Qe=new Intl.NumberFormat(`vi-VN`,{style:`currency`,currency:`VND`,maximumFractionDigits:0}),$e=new Intl.DateTimeFormat(`vi-VN`,{day:`2-digit`,month:`2-digit`,year:`numeric`,hour:`2-digit`,minute:`2-digit`});function et(e){return Qe.format(Number(e))}function tt(e){return $e.format(new Date(e))}function nt(e){return e===`COMPLETED`?`DELIVERED`:e}async function rt(e,t){return T.request(e,t)}function it(){let[e,t]=(0,l.useState)([]),[n,r]=(0,l.useState)(1),[i,a]=(0,l.useState)(null),[o,s]=(0,l.useState)(`ALL`),[c,u]=(0,l.useState)(!0),[d,p]=(0,l.useState)(null),[m,h]=(0,l.useState)(null),g=(0,l.useCallback)((e,t)=>{h({type:e,message:t}),window.setTimeout(()=>h(null),3e3)},[]),_=(0,l.useCallback)(async()=>{u(!0);try{let e=await rt(`/admin/orders?page=${n}&limit=10`);t(e.data??e.orders??[]),a(e.meta??(e.pagination?{totalItems:e.pagination.total??0,totalPages:e.pagination.totalPages??1,currentPage:e.pagination.page??n,limit:e.pagination.limit??10}:null))}catch{g(`error`,`Không thể tải danh sách đơn hàng.`)}finally{u(!1)}},[n,g]);(0,l.useEffect)(()=>{_()},[_]);let v=(0,l.useMemo)(()=>o===`ALL`?e:e.filter(e=>nt(e.status)===o),[o,e]),y=async(e,t)=>{p(e);try{await T.put(`/admin/orders/${e}/status`,{status:t}),g(`success`,`Đã cập nhật trạng thái đơn hàng.`),await _()}catch{g(`error`,`Không thể cập nhật trạng thái đơn hàng.`)}finally{p(null)}};return(0,f.jsxs)(`section`,{className:`order-management`,children:[(0,f.jsx)(`style`,{children:at}),m&&(0,f.jsx)(`div`,{className:`order-management-toast order-management-toast-${m.type}`,role:`status`,children:m.message}),(0,f.jsxs)(`div`,{className:`order-management-header`,children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`p`,{children:`Quản trị đơn hàng`}),(0,f.jsx)(`h2`,{children:`Danh sách đơn hàng`})]}),(0,f.jsx)(`button`,{type:`button`,className:`order-management-refresh`,onClick:()=>void _(),children:`Tải lại`})]}),(0,f.jsx)(`div`,{className:`order-management-tabs`,role:`tablist`,"aria-label":`Lọc trạng thái đơn hàng`,children:Xe.map(e=>{let t=o===e.value;return(0,f.jsx)(`button`,{type:`button`,role:`tab`,"aria-selected":t,className:t?`order-management-tab active`:`order-management-tab`,onClick:()=>s(e.value),children:e.label},e.value)})}),(0,f.jsxs)(`div`,{className:`order-management-panel`,children:[c?(0,f.jsxs)(`div`,{className:`order-management-loading`,children:[(0,f.jsx)(`span`,{className:`order-management-spinner`}),`Đang tải danh sách đơn hàng...`]}):(0,f.jsxs)(`div`,{className:`order-management-table-wrap`,children:[(0,f.jsxs)(`table`,{className:`order-management-table`,children:[(0,f.jsx)(`thead`,{children:(0,f.jsxs)(`tr`,{children:[(0,f.jsx)(`th`,{children:`Mã đơn`}),(0,f.jsx)(`th`,{children:`Ngày đặt`}),(0,f.jsx)(`th`,{children:`Phương thức thanh toán`}),(0,f.jsx)(`th`,{children:`Sản phẩm`}),(0,f.jsx)(`th`,{children:`Tổng tiền`}),(0,f.jsx)(`th`,{children:`Trạng thái đơn hàng`}),(0,f.jsx)(`th`,{children:`Trạng thái thanh toán`}),(0,f.jsx)(`th`,{children:`Thao tác nhanh`})]})}),(0,f.jsx)(`tbody`,{children:v.map(e=>{let t=nt(e.status),n=d===e.id;return(0,f.jsxs)(`tr`,{children:[(0,f.jsxs)(`td`,{className:`order-management-id`,children:[`#`,e.id]}),(0,f.jsx)(`td`,{children:tt(e.createdAt)}),(0,f.jsx)(`td`,{children:e.paymentMethod}),(0,f.jsx)(`td`,{children:(0,f.jsxs)(`div`,{className:`order-management-products`,children:[(0,f.jsxs)(`strong`,{children:[e.items.length,` sản phẩm`]}),(0,f.jsx)(`span`,{children:e.items.slice(0,2).map(e=>e.product?.name).filter(Boolean).join(`, `)||`Không có chi tiết`})]})}),(0,f.jsx)(`td`,{className:`order-management-money`,children:et(e.total)}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`span`,{className:`order-management-status status-${t.toLowerCase()}`,children:Ze[t]??t})}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`span`,{className:`order-management-status status-${e.paymentStatus.toLowerCase()}`,children:Ze[e.paymentStatus]??e.paymentStatus})}),(0,f.jsx)(`td`,{children:(0,f.jsx)(`div`,{className:`order-actions`,children:(0,f.jsxs)(`select`,{value:e.status===`COMPLETED`?`SHIPPED`:e.status,disabled:n,onChange:t=>{y(e.id,t.target.value)},children:[(0,f.jsx)(`option`,{value:`PENDING`,children:`Chờ xử lý`}),(0,f.jsx)(`option`,{value:`PROCESSING`,children:`Đang xử lý`}),(0,f.jsx)(`option`,{value:`SHIPPED`,children:`Đã giao`}),(0,f.jsx)(`option`,{value:`CANCELLED`,children:`Đã hủy`}),(0,f.jsx)(`option`,{value:`COMPLETED`,children:`Đã hoàn thành`})]})})})]},e.id)})})]}),v.length===0&&(0,f.jsx)(`p`,{className:`order-management-empty`,children:`Không có đơn hàng nào trong trạng thái này.`})]}),!c&&(0,f.jsx)(A,{currentPage:n,totalPages:i?.totalPages||1,onPageChange:e=>r(e)})]})]})}var at=`
  .order-management {
    color: #0f172a;
    text-align: left;
  }
...
`,ot=`/api/v1/monitor`,st=[{id:`overview`,label:`Tổng quan`},{id:`orders`,label:`Đơn hàng`},{id:`vouchers`,label:`Voucher`},{id:`ai-control`,label:`Cấu hình AI`},{id:`catalog`,label:`Danh mục sản phẩm`},{id:`users`,label:`Quản lý khách hàng`}],ct=new Intl.NumberFormat(`vi-VN`,{style:`currency`,currency:`VND`,maximumFractionDigits:0});function lt(e){return ct.format(Number(e))}function ut(){let[e,t]=(0,l.useState)(`overview`),[n,r]=(0,l.useState)(null),[i,a]=(0,l.useState)(!0),[o,s]=(0,l.useState)(null),c=(0,l.useCallback)((e,t)=>{s({type:e,message:t}),window.setTimeout(()=>s(null),3200)},[]),u=(0,l.useCallback)(async()=>{a(!0);try{r((await T.get(`/admin/stats`)).data)}catch{c(`error`,`Không thể tải số liệu tổng quan.`)}finally{a(!1)}},[c]);(0,l.useEffect)(()=>{u()},[u]);let d=(0,l.useMemo)(()=>n?n.orderStatusCounts.PENDING+n.orderStatusCounts.PROCESSING+n.orderStatusCounts.DELIVERED:0,[n]);return(0,f.jsxs)(`div`,{className:`admin-shell`,children:[(0,f.jsx)(`style`,{children:dt}),o&&(0,f.jsx)(`div`,{className:`admin-toast admin-toast-${o.type}`,role:`status`,children:o.message}),(0,f.jsxs)(`aside`,{className:`admin-sidebar`,children:[(0,f.jsxs)(`div`,{className:`admin-brand`,children:[(0,f.jsx)(`span`,{className:`admin-brand-mark`,children:`AD`}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`h1`,{children:`Admin Panel`}),(0,f.jsx)(`p`,{children:`Quản trị vận hành`})]})]}),(0,f.jsxs)(`nav`,{className:`admin-nav`,children:[st.map(n=>(0,f.jsx)(`button`,{type:`button`,className:e===n.id?`admin-nav-item active`:`admin-nav-item`,onClick:()=>t(n.id),children:n.label},n.id)),(0,f.jsxs)(`a`,{className:`admin-nav-item admin-nav-link`,href:ot,target:`_blank`,rel:`noreferrer`,children:[(0,f.jsxs)(`svg`,{"aria-hidden":`true`,className:`admin-nav-icon`,fill:`none`,viewBox:`0 0 24 24`,children:[(0,f.jsx)(`path`,{d:`M4 7c0-1.66 3.58-3 8-3s8 1.34 8 3-3.58 3-8 3-8-1.34-8-3Z`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`}),(0,f.jsx)(`path`,{d:`M4 7v5c0 1.66 3.58 3 8 3s8-1.34 8-3V7`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`}),(0,f.jsx)(`path`,{d:`M4 12v5c0 1.66 3.58 3 8 3s8-1.34 8-3v-5`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2`})]}),(0,f.jsx)(`span`,{children:`Giám sát Queue (Redis)`})]})]})]}),(0,f.jsxs)(`main`,{className:`admin-main`,children:[(0,f.jsxs)(`header`,{className:`admin-header`,children:[(0,f.jsx)(`p`,{className:`admin-eyebrow`,children:`Trung tâm quản trị`}),(0,f.jsx)(`h2`,{children:`DUT SHOP`})]}),e===`overview`&&(0,f.jsxs)(`section`,{className:`admin-section`,children:[(0,f.jsxs)(`div`,{className:`kpi-grid`,children:[(0,f.jsxs)(`article`,{className:`kpi-card`,children:[(0,f.jsx)(`span`,{children:`Doanh thu`}),(0,f.jsx)(`strong`,{children:i?`...`:lt(n?.totalRevenue??0)})]}),(0,f.jsxs)(`article`,{className:`kpi-card`,children:[(0,f.jsx)(`span`,{children:`Đơn hàng`}),(0,f.jsx)(`strong`,{children:i?`...`:n?.totalOrders??0})]}),(0,f.jsxs)(`article`,{className:`kpi-card`,children:[(0,f.jsx)(`span`,{children:`Khách hàng`}),(0,f.jsx)(`strong`,{children:i?`...`:n?.totalUsers??0})]})]}),(0,f.jsxs)(`section`,{className:`content-panel`,children:[(0,f.jsxs)(`div`,{className:`panel-title`,children:[(0,f.jsx)(`h3`,{children:`Tỷ lệ trạng thái đơn hàng`}),(0,f.jsx)(`p`,{children:`Theo dõi nhanh đơn đã giao, đang xử lý và đang chờ xử lý.`})]}),(0,f.jsx)(`div`,{className:`progress-list`,children:[{label:`Đã giao`,value:n?.orderStatusCounts.DELIVERED??0,className:`progress-delivered`},{label:`Đang xử lý`,value:n?.orderStatusCounts.PROCESSING??0,className:`progress-processing`},{label:`Chờ xử lý`,value:n?.orderStatusCounts.PENDING??0,className:`progress-pending`}].map(e=>{let t=d>0?Math.round(e.value/d*100):0;return(0,f.jsxs)(`div`,{className:`progress-row`,children:[(0,f.jsxs)(`div`,{className:`progress-meta`,children:[(0,f.jsx)(`span`,{children:e.label}),(0,f.jsxs)(`span`,{children:[e.value,` đơn · `,t,`%`]})]}),(0,f.jsx)(`div`,{className:`progress-track`,children:(0,f.jsx)(`div`,{className:`progress-fill ${e.className}`,style:{width:`${t}%`}})})]},e.label)})})]})]}),e===`orders`&&(0,f.jsx)(`section`,{className:`content-panel`,children:(0,f.jsx)(it,{})}),e===`vouchers`&&(0,f.jsx)(`section`,{className:`admin-section`,children:(0,f.jsx)(Je,{})}),e===`ai-control`&&(0,f.jsx)(`section`,{className:`admin-section`,children:(0,f.jsx)(le,{})}),e===`catalog`&&(0,f.jsx)(`section`,{className:`admin-section`,children:(0,f.jsx)(Se,{})}),e===`inventory`&&(0,f.jsx)(`section`,{className:`admin-section`,children:(0,f.jsx)(je,{})}),e===`users`&&(0,f.jsx)(`section`,{className:`admin-section`,children:(0,f.jsx)(ze,{})})]})]})}var dt=`
  .admin-shell {
    min-height: 100vh;
    display: grid;
...
`;function ft(){window.history.replaceState(null,``,`/admin`),window.dispatchEvent(new PopStateEvent(`popstate`))}async function pt(e,t){let n=await T.post(`/auth/admin-login`,{email:e,password:t},{auth:!1});if(!n.token)throw Error(n.message??`Không thể đăng nhập. Vui lòng thử lại.`);return n.token}function mt(){let[e,t]=(0,l.useState)(``),[n,r]=(0,l.useState)(``),[i,a]=(0,l.useState)(``),[o,s]=(0,l.useState)(!1),c=async t=>{t.preventDefault(),a(``),s(!0);try{let t=await pt(e.trim(),n);localStorage.setItem(`adminToken`,t),localStorage.setItem(`token`,t),ft()}catch(e){a(e instanceof Error?e.message:`Đăng nhập không thành công.`)}finally{s(!1)}};return(0,f.jsx)(`main`,{className:`login-screen min-h-screen bg-slate-950 text-slate-950`,children:(0,f.jsxs)(`section`,{className:`login-shell mx-auto grid min-h-screen max-w-6xl items-center gap-10 px-6 py-10 lg:grid-cols-[1fr_440px]`,children:[(0,f.jsxs)(`div`,{className:`login-copy hidden text-white lg:block`,children:[(0,f.jsx)(`p`,{className:`login-eyebrow text-sm font-semibold uppercase tracking-[0.22em] text-cyan-200`,children:`Hệ thống quản trị`}),(0,f.jsx)(`h1`,{className:`mt-5 max-w-2xl text-5xl font-bold leading-tight tracking-normal`,children:`Kiểm soát vận hành bán hàng trong một bảng điều khiển tập trung.`}),(0,f.jsx)(`p`,{className:`mt-5 max-w-xl text-base leading-7 text-slate-300`,children:`Đăng nhập bằng tài khoản quản trị để theo dõi doanh thu, xử lý đơn hàng, quản lý voucher và điều phối AI.`})]}),(0,f.jsxs)(`form`,{className:`login-card rounded-xl border border-white/15 bg-white p-8 shadow-2xl`,onSubmit:e=>void c(e),children:[(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`p`,{className:`text-sm font-semibold uppercase tracking-[0.18em] text-slate-500`,children:`Admin Panel`}),(0,f.jsx)(`h2`,{className:`mt-3 text-3xl font-bold tracking-normal text-slate-950`,children:`Đăng nhập`}),(0,f.jsx)(`p`,{className:`mt-2 text-sm leading-6 text-slate-500`,children:`Chỉ tài khoản có quyền ADMIN mới có thể truy cập khu vực này.`})]}),i&&(0,f.jsx)(`div`,{className:`login-alert mt-6 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700`,children:i}),(0,f.jsxs)(`div`,{className:`mt-7 grid gap-5`,children:[(0,f.jsxs)(`label`,{className:`grid gap-2 text-sm font-semibold text-slate-700`,children:[`Email`,(0,f.jsx)(`input`,{required:!0,autoComplete:`email`,className:`h-12 rounded-lg border border-slate-300 bg-white px-4 text-base text-slate-950 outline-none transition focus:border-slate-950 focus:ring-4 focus:ring-slate-200`,type:`email`,value:e,onChange:e=>t(e.target.value),placeholder:`admin@example.com`})]}),(0,f.jsxs)(`label`,{className:`grid gap-2 text-sm font-semibold text-slate-700`,children:[`Mật khẩu`,(0,f.jsx)(`input`,{required:!0,autoComplete:`current-password`,className:`h-12 rounded-lg border border-slate-300 bg-white px-4 text-base text-slate-950 outline-none transition focus:border-slate-950 focus:ring-4 focus:ring-slate-200`,type:`password`,value:n,onChange:e=>r(e.target.value),placeholder:`Nhập mật khẩu quản trị`})]})]}),(0,f.jsx)(`button`,{className:`login-submit mt-7 inline-flex h-12 w-full items-center justify-center rounded-lg bg-slate-950 px-5 text-sm font-bold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-70`,disabled:o,type:`submit`,children:o?`Đang đăng nhập...`:`Đăng nhập`})]})]})})}function ht(){let[e,t]=(0,l.useState)(window.location.pathname);return(0,l.useEffect)(()=>{let e=()=>t(window.location.pathname);return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[]),e===`/admin/login`?(0,f.jsx)(mt,{}):(0,f.jsx)(_,{children:(0,f.jsx)(ut,{})})}(0,u.createRoot)(document.getElementById(`root`)).render((0,f.jsx)(l.StrictMode,{children:(0,f.jsx)(ht,{})}));